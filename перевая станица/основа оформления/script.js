document.addEventListener('DOMContentLoaded', function() {
    ...
    themeToggleBtn.addEventListener('click', function() {
        ...
        applyTheme(isDarkTheme, logoImg);
    });
...
// Функция для применения темы к другим элементам на странице (в данном случае, к логотипу)
function applyTheme(isDarkTheme, logoImg) {
    const logoPath = isDarkTheme ? 'Img/DarkLogo.png' : 'Img/WhiteLogo.png';
    logoImg.src = logoPath;
}



// Функция для применения темы к другим элементам на странице (в данном случае, к логотипу и header)
function applyTheme(isDarkTheme, logoImg) {
    const logoPath = isDarkTheme ? 'Img/DarkLogo.png' : 'Img/WhiteLogo.png';
    logoImg.src = logoPath;
